...
```{r}
#| label: fig-model-one
#| fig-cap: "Summary of the negative binomal fitted model."
#| eval: true
#| echo: false
#| message: false
#| warning: false
